...
def main(cfg):
    ...
    # init
    # motion_vq_config = LoraConfig(peft_type=TaskType.FEATURE_EXTRACTION, 
    #                               r=8, 
    ...
    audio_model_config = LoraConfig(peft_type=TaskType.FEATURE_EXTRACTION,
